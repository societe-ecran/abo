...
const sourcesEtTraductions = () => {
    ...
    const data = [
        ...
        { isSommaire: false, sommaire: " Never give up ! La lutte contre les crimes policiers aux États-Unis", titreOrignal: 'Never give up!', titreTraduit: 'Never give up ! La lutte contre les crimes policiers aux États-Unis', auteur: ' N. Serfaty', href: 'https://lundi.am/Never-Give-Up-la-lutte-noire-pour-l-abolition-aux-Etats-Unis', link: "/Traductions/neverGiveUp" },
