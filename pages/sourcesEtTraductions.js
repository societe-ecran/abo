...
const sourcesEtTraductions = () => {
    ...
    const data = [
        ...
        { isSommaire: true, sommaire: "A. L’urgence du moment et la patience d’un millier d’années", titreOrignal: '', titreTraduit: '', auteur: '', href: '', link: '' },
        ...
        { isSommaire: true, sommaire: "B. SLa violence en armes", titreOrignal: '', titreTraduit: '', auteur: '', href: '', link: '' },
